...
#am__append_11 = gcj_mlc.c
#am__append_12 = fnlz_mlc.c
am__append_13 = include/gc_pthread_redirects.h
am__append_14 = include/gc_gcj.h
am__append_15 = include/gc_disclaim.h
##am__append_16 = libatomic_ops/src/atomic_ops_sysdeps.S

# C++ Interface
# -------------
#am__append_17 = libgccpp.la
#am__append_18 = include/gc_allocator.h include/gc_cpp.h
#am__append_19 = include/extra/gc_cpp.h
# The same as libgccpp but contains only gc_badalc.o.
##am__append_20 = libgctba.la
am__append_21 = $(top_builddir)/libgc.la
am__append_22 = $(THREADDLLIBS)

# Note: because of libtool, you'll need to point your browser to
# .libs/gctest.html, not gctest.html at topdir.
#am__append_23 = gctest.html
am__append_24 = $(top_builddir)/libgc.la
#am__append_25 = tracetest$(EXEEXT)
#am__append_26 = tracetest
am__append_27 = test_atomic_ops$(EXEEXT) \
	threadleaktest$(EXEEXT) threadkey_test$(EXEEXT) \
	subthreadcreate_test$(EXEEXT) \
	initsecondarythread_test$(EXEEXT)
am__append_28 = test_atomic_ops threadleaktest \
	threadkey_test subthreadcreate_test \
	initsecondarythread_test
#am__append_29 = test_cpp$(EXEEXT)
#am__append_30 = test_cpp
#am__append_31 = $(top_builddir)/libgc.la
am__append_32 = disclaim_test$(EXEEXT) \
	disclaim_bench$(EXEEXT) \
	disclaim_weakmap_test$(EXEEXT)
am__append_33 = disclaim_test disclaim_bench \
	disclaim_weakmap_test
am__append_34 = $(THREADDLLIBS)
am__append_35 = $(THREADDLLIBS)
subdir = .
...
#am__EXEEXT_1 = gctest.html$(EXEEXT)
#am__EXEEXT_2 = tracetest$(EXEEXT)
am__EXEEXT_3 = test_atomic_ops$(EXEEXT) \
	threadleaktest$(EXEEXT) threadkey_test$(EXEEXT) \
	subthreadcreate_test$(EXEEXT) \
	initsecondarythread_test$(EXEEXT)
#am__EXEEXT_4 = test_cpp$(EXEEXT)
am__EXEEXT_5 = disclaim_test$(EXEEXT) \
	disclaim_bench$(EXEEXT) \
	disclaim_weakmap_test$(EXEEXT)
...
#	$(am__objects_9)
am_libgc_la_OBJECTS = extra/gc.lo \
...
#am_libgccpp_la_OBJECTS = gc_badalc.lo gc_cpp.lo
...
##libgctba_la_DEPENDENCIES =  \
##	libgc.la
am__libgctba_la_SOURCES_DIST = gc_badalc.cc
##am_libgctba_la_OBJECTS =  \
##	gc_badalc.lo
...
am_disclaim_weakmap_test_OBJECTS =  \
	tests/disclaim_weakmap_test.$(OBJEXT)
disclaim_weakmap_test_OBJECTS = $(am_disclaim_weakmap_test_OBJECTS)
disclaim_weakmap_test_DEPENDENCIES =  \
	$(am__DEPENDENCIES_2) \
	$(am__DEPENDENCIES_3)
...
test_atomic_ops_DEPENDENCIES = $(am__DEPENDENCIES_2) \
	$(am__DEPENDENCIES_1)
...
ACLOCAL = ${SHELL} '/home/funkytaiga/tools/gc-8.2.2/missing' aclocal-1.16
AMTAR = $${TAR-tar}
...
ATOMIC_OPS_CFLAGS = 
ATOMIC_OPS_LIBS = 
AUTOCONF = ${SHELL} '/home/funkytaiga/tools/gc-8.2.2/missing' autoconf
AUTOHEADER = ${SHELL} '/home/funkytaiga/tools/gc-8.2.2/missing' autoheader
AUTOMAKE = ${SHELL} '/home/funkytaiga/tools/gc-8.2.2/missing' automake-1.16
AWK = mawk
CC = gcc
CCAS = gcc
...
CFLAGS = -DGC_VISIBILITY_HIDDEN_SET -fvisibility=hidden -Wall -Wextra -Wpedantic -Wno-long-long -g -O2 -fno-strict-aliasing -Wno-frame-address $(CFLAGS_EXTRA)
CFLAGS_EXTRA = 
CPP = gcc -E
CPPFLAGS = 
CSCOPE = cscope
...
CXXFLAGS = -Wall -Wextra -Wpedantic -Wno-long-long -g -O2 $(CFLAGS_EXTRA)
CXXLIBS = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} '/home/funkytaiga/tools/gc-8.2.2/missing' makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
VERSION = 8.2.2
WERROR_CFLAGS = 
abs_builddir = /home/funkytaiga/tools/gc-8.2.2
abs_srcdir = /home/funkytaiga/tools/gc-8.2.2
abs_top_builddir = /home/funkytaiga/tools/gc-8.2.2
abs_top_srcdir = /home/funkytaiga/tools/gc-8.2.2
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/funkytaiga/tools/gc-8.2.2/install-sh
...
#	gc_dlopen.c headers.c mach_dep.c malloc.c \
#	mallocx.c mark.c mark_rts.c misc.c \
#	new_hblk.c obj_map.c os_dep.c ptr_chck.c \
#	reclaim.c specific.c typd_mlc.c \
...
#test_cpp_LDADD = libgccpp.la \
#	$(nodist_libgc_la_OBJECTS) \
#	$(EXTRA_TEST_LIBS) \
#	$(CXXLIBS) \
#	$(am__append_31)
##test_cpp_LDADD = gc_badalc.o \
##	gc_cpp.o $(test_ldadd) \
##	$(CXXLIBS) \
##	$(am__append_31)
...
include ./$(DEPDIR)/allchblk.Plo # am--include-marker
include ./$(DEPDIR)/alloc.Plo # am--include-marker
include ./$(DEPDIR)/backgraph.Plo # am--include-marker
include ./$(DEPDIR)/blacklst.Plo # am--include-marker
include ./$(DEPDIR)/checksums.Plo # am--include-marker
include ./$(DEPDIR)/darwin_stop_world.Plo # am--include-marker
include ./$(DEPDIR)/dbg_mlc.Plo # am--include-marker
include ./$(DEPDIR)/dyn_load.Plo # am--include-marker
include ./$(DEPDIR)/finalize.Plo # am--include-marker
include ./$(DEPDIR)/fnlz_mlc.Plo # am--include-marker
include ./$(DEPDIR)/gc_badalc.Plo # am--include-marker
include ./$(DEPDIR)/gc_cpp.Plo # am--include-marker
include ./$(DEPDIR)/gc_dlopen.Plo # am--include-marker
include ./$(DEPDIR)/gcj_mlc.Plo # am--include-marker
include ./$(DEPDIR)/headers.Plo # am--include-marker
include ./$(DEPDIR)/mach_dep.Plo # am--include-marker
include ./$(DEPDIR)/malloc.Plo # am--include-marker
include ./$(DEPDIR)/mallocx.Plo # am--include-marker
include ./$(DEPDIR)/mark.Plo # am--include-marker
include ./$(DEPDIR)/mark_rts.Plo # am--include-marker
include ./$(DEPDIR)/misc.Plo # am--include-marker
include ./$(DEPDIR)/new_hblk.Plo # am--include-marker
include ./$(DEPDIR)/obj_map.Plo # am--include-marker
include ./$(DEPDIR)/os_dep.Plo # am--include-marker
include ./$(DEPDIR)/pthread_start.Plo # am--include-marker
include ./$(DEPDIR)/pthread_stop_world.Plo # am--include-marker
include ./$(DEPDIR)/pthread_support.Plo # am--include-marker
include ./$(DEPDIR)/ptr_chck.Plo # am--include-marker
include ./$(DEPDIR)/reclaim.Plo # am--include-marker
include ./$(DEPDIR)/sparc_mach_dep.Plo # am--include-marker
include ./$(DEPDIR)/specific.Plo # am--include-marker
include ./$(DEPDIR)/thread_local_alloc.Plo # am--include-marker
include ./$(DEPDIR)/typd_mlc.Plo # am--include-marker
include ./$(DEPDIR)/win32_threads.Plo # am--include-marker
include cord/$(DEPDIR)/libcord_la-cordbscs.Plo # am--include-marker
include cord/$(DEPDIR)/libcord_la-cordprnt.Plo # am--include-marker
include cord/$(DEPDIR)/libcord_la-cordxtra.Plo # am--include-marker
include cord/tests/$(DEPDIR)/cordtest.Po # am--include-marker
include extra/$(DEPDIR)/gc.Plo # am--include-marker
include libatomic_ops/src/$(DEPDIR)/atomic_ops.Plo # am--include-marker
include libatomic_ops/src/$(DEPDIR)/atomic_ops_sysdeps.Plo # am--include-marker
include tests/$(DEPDIR)/disclaim_bench.Po # am--include-marker
include tests/$(DEPDIR)/disclaim_test.Po # am--include-marker
include tests/$(DEPDIR)/disclaim_weakmap_test.Po # am--include-marker
include tests/$(DEPDIR)/huge_test.Po # am--include-marker
include tests/$(DEPDIR)/initsecondarythread.Po # am--include-marker
include tests/$(DEPDIR)/leak_test.Po # am--include-marker
include tests/$(DEPDIR)/libstaticrootslib2_test_la-staticrootslib.Plo # am--include-marker
include tests/$(DEPDIR)/middle.Po # am--include-marker
include tests/$(DEPDIR)/realloc_test.Po # am--include-marker
include tests/$(DEPDIR)/smash_test.Po # am--include-marker
include tests/$(DEPDIR)/staticrootslib.Plo # am--include-marker
include tests/$(DEPDIR)/staticrootstest-staticrootstest.Po # am--include-marker
include tests/$(DEPDIR)/subthread_create.Po # am--include-marker
include tests/$(DEPDIR)/test.Po # am--include-marker
include tests/$(DEPDIR)/test_atomic_ops.Po # am--include-marker
include tests/$(DEPDIR)/test_cpp.Po # am--include-marker
include tests/$(DEPDIR)/thread_leak_test.Po # am--include-marker
include tests/$(DEPDIR)/threadkey_test.Po # am--include-marker
include tests/$(DEPDIR)/trace_test.Po # am--include-marker
